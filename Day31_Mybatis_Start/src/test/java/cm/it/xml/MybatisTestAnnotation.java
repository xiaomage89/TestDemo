...
import cm.it.dao.IUserDaoAnnotation;
...
public class MybatisTestAnnotation {
    public static void main(String[] args) throws IOException {
        ...
        IUserDaoAnnotation dao = session.getMapper(IUserDaoAnnotation.class);
        //6.使用代理对象执行查询所有方法
        List<UserAnnotation> list = dao.findAll();
        for (UserAnnotation userAnnotation : list){
